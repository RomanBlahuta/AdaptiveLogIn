...
const Background = () => {
    ...
    const renderBackground = (size) => {
        if (size === 'lg') {
            ...
            return (
                <div>
                    <img src={Plus} alt={alts.plus} className={`${Background__image} ${Background__plus_right_sm}`} />
                    <img src={Plus} alt={alts.plus} className={`${Background__image} ${Background__plus_left_sm}`} />
                    <img
                        src={Spring}
                        alt={alts.spring}
                    ...
                    <img src={Notes} alt={alts.notes} className={`${Background__image} ${Background__notes}`} />
                    <img src={Weather} alt={alts.weather} className={`${Background__image} ${Background__weather}`} />
                    <img src={Gallery} alt={alts.gallery} className={`${Background__image} ${Background__gallery}`} />
                </div>
            );
        } else {
            return (
                <div>
                    <img src={Plus} alt={alts.plus} className={`${Background__image} ${Background__plus_right_xs}`} />
                    <img
                        src={Spring}
                        alt={alts.spring}
